...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.hello'
        db.add_column('blog_blogpost', 'hello',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.hello'
        db.delete_column('blog_blogpost', 'hello')
    ...
    models = {
        ...
        'blog.blogpost': {
            ...
            'hello': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
